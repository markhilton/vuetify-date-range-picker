...
}, Oy = /* @__PURE__ */ Un(Dy, [["__scopeId", "data-v-75d35efc"]]), Ey = { class: "date-picker-tablet elevation-4 mx-auto" }, Ay = {
...
}, Uy = /* @__PURE__ */ Un(Wy, [["styles", [Ny, Fy]], ["__scopeId", "data-v-69077bb6"]]), Hy = {
  debug: !1,
  store: null
  // vuex store
...
const p_ = {
  install: (e, t = {}) => {
    ...
    r == null && (r = yu(), e.use(r), n.debug && console.log("[ date picker ]: INFO: using local Store")), n.debug && console.log("[ DateRangePicker ]: Options: ", t), t?.storeNames ? (n.debug && console.log("[ DateRangePicker ]:", t?.storeNames), t.storeNames.forEach((i) => {
      ...
      s().SET_DEBUG(n.debug), [!0, !1].includes(i?.config?.showPresetsIcon) && s().SET_PRESET_ICON_SHOWN(!!i?.config?.showPresetsIcon), [!0, !1].includes(i?.config?.showCalendarIcon) && s().SET_CALENDAR_ICON_SHOWN(!!i?.config?.showCalendarIcon), [!0, !1].includes(i?.config?.showCompare) && s().SET_PRESET_ICON_SHOWN(!!i?.config?.showCompare), Hs[i.name] = s();
    })) : (n.debug && console.log("[ DateRangePicker ]: "), a = Ni("datePickerStore", Bs), a().SET_DEBUG(n.debug), [!0, !1].includes(n.showPresetsIcon) && a().SET_PRESET_ICON_SHOWN(!!n.showPresetsIcon), [!0, !1].includes(n.showCalendarIcon) && a().SET_CALENDAR_ICON_SHOWN(!!n.showCalendarIcon), [!0, !1].includes(n.showCompare) && a().SET_PRESET_ICON_SHOWN(!!n.showCompare), Hs.datePickerStore = a()), e.config.globalProperties.$pinia || (console.log("[ DateRangePicker ]: pinia store not detected - creating..."), e.use(r)), e.directive("mask", Gu), e.component("DateRangePicker", Uy), console.log("[ DateRangePicker ]: wrapper initialization completed...");
  }
};
export {
