(function (global, factory) {
  ...
  var getters = {
    ...
    getPickerDate: function getPickerDate(state) {
      return moment__default['default'](state.picker_active_mount).format(presets.MONTH_FORMAT)
    },

    getPickerPrimaryLeft: function getPickerPrimaryLeft(state) {
      return moment__default['default'](state.picker_active_mount).subtract(1, "month").format(presets.MONTH_FORMAT)
    },
    ...
    getDefaultDateFormat: function getDefaultDateFormat() {
      return function (date) {
        return moment__default['default'](date).format(presets.DEFAULT_FORMAT)
      }
    },
  };
  ...
  var script = {
    ...
    methods: Object.assign({}, mapMutations(["FLIP_COMPARE_STATE", "SET_DIALOG_OPENED"]))
  };
  ...
  var script$1 = {
    ...
    computed: Object.assign({}, mapGetters(["getPrimaryPreset"])),

    methods: Object.assign({}, mapMutations(["SET_PRIMARY_PRESET"]))
  };
  ...
  var script$2 = {
    ...
    computed: Object.assign({}, mapGetters(["getCompareState", "getComparePreset"])),

    methods: Object.assign({}, mapMutations(["SET_COMPARE_PRESET"]))
  };
                      ...
                      ? _c(
                          ...
                          [
                            _c(
                              ...
                              { attrs: { cols: "6" } },
                              [
                                _c("p", [_vm._v("Compare Picker Left")]),
                                _vm._v(" "),
                                _c("v-date-picker", {
                                  staticClass: "pr-1",
                                  attrs: {
                            ...
                            _c(
                              ...
                              { attrs: { cols: "6" } },
                              [
                                _c("p", [_vm._v("Compare Picker Right")]),
                                _vm._v(" "),
                                _c("v-date-picker", {
                                  attrs: {
                                    range: "",
  ...
  var script$6 = {
    ...
    computed: Object.assign({}, mapGetters(["isDialogOpened"])),
    ...
    methods: Object.assign({}, mapMutations(["SET_DIALOG_OPENED", "SET_PROPS"])),
  };
