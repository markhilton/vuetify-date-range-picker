(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('vuetify/lib'), require('@/presets/utils/common')) :
		typeof define === 'function' && define.amd ? define(['exports', 'vuetify/lib', '@/presets/utils/common'], factory) :
		...
		methods: {
			...
			updateComparePeriod: function updateComparePeriod() {
				if (
					...
					var ref = this.presets[this.datePreset].compare[this.currSelectedCompare.id];
			...
			applySetting: function applySetting() {
				...
				var compareUntil = this.range && this.range.end ? moment(this.range.end).format(INTERNAL_DATE_FORMAT_1$1) : "";
				var desktopConfig = {
			...
			reloadType: function reloadType() {
				...
				if (this.dateRange) {
					...
					// init configuration
					var ref = this.presets[this.datePreset].period;
					var start = ref.start;
					var end = ref.end;
									...
									[
										_c(
											...
											[
												_c(
													...
													{
														model: {
															value: _vm.datePreset,
															callback: function ($$v) {
																_vm.datePreset = $$v;
															},
															expression: "datePreset"
														}
													},
										...
										_c("v-select", {
											attrs: {
												...
												items: _vm.presets[_vm.datePreset].compareArray,
												"item-text": "label",
												"item-value": "id",
												"return-object": "",
												solo: ""
	...
	var script$4 = {
		props: {
			dateRange: {
				...
				dateFormat: {
					type: String,
					default: function () { return moment().format("MMM D, YYYY"); },
				},
			},
			showDashboardDateSetting: {
				type: Boolean,
		...
		components: {
			...
			VIcon: lib.VIcon,
			VListItemIcon: lib.VListItemIcon,
		...
		methods: {
			...
			setDateRange: function setDateRange(param) {
			...
			[
				_c(
					"v-menu",
					{
						attrs: {
							dark: _vm.dark,
							"close-on-content-click": !_vm.opened,
							"close-on-click": !_vm.opened
						},
						scopedSlots: _vm._u([
							{
								key: "activator",
								...
								[
									!_vm.isMobile
										? _c("date-range-picker-desktop", {
											attrs: { dark: _vm.dark, dateRange: _vm.dateRange },
											on: {
	...
	exports.COMPARE_PERIODS_DESKTOP = COMPARE_PERIODS_DESKTOP;
	exports.CUSTOM_COMPARE = CUSTOM_COMPARE;
	exports.DEFAULT_CUSTOM_DATE = DEFAULT_CUSTOM_DATE;
	exports.DEFAULT_MOBILE_CONFIG = DEFAULT_MOBILE_CONFIG;
	exports.DEFAULT_TYPE_SELECTION = DEFAULT_TYPE_SELECTION;
	exports.DISPLAY_DATE_FORMAT_1 = DISPLAY_DATE_FORMAT_1;
	exports.DISPLAY_DATE_FORMAT_2 = DISPLAY_DATE_FORMAT_2;
	exports.DISPLAY_DATE_FORMAT_3 = DISPLAY_DATE_FORMAT_3;
	exports.INTERNAL_DATE_FORMAT_1 = INTERNAL_DATE_FORMAT_1$1;
	exports.INTERNAL_DATE_FORMAT_2 = INTERNAL_DATE_FORMAT_2$1;
	exports.PERIOD_COMPARE_CONVERT_LIST_DESKTOP = PERIOD_COMPARE_CONVERT_LIST_DESKTOP;
	exports.PERIOD_COMPARE_CONVERT_LIST_MOBILE = PERIOD_COMPARE_CONVERT_LIST_MOBILE;
	exports.PERIOD_CONVERT_LIST_DESKTOP = PERIOD_CONVERT_LIST_DESKTOP;
	exports.PERIOD_CONVERT_LIST_MOBILE = PERIOD_CONVERT_LIST_MOBILE;
	exports.PERIOD_DAY = PERIOD_DAY;
	exports.PERIOD_DAY_COMPARE = PERIOD_DAY_COMPARE;
	exports.PERIOD_MONTH = PERIOD_MONTH;
	exports.PERIOD_MONTH_COMPARE = PERIOD_MONTH_COMPARE;
	exports.PERIOD_TYPE = PERIOD_TYPE;
	exports.PERIOD_WEEK = PERIOD_WEEK;
	exports.PERIOD_WEEK_COMPARE = PERIOD_WEEK_COMPARE;
	exports.PRESETS_DEFAULT_DESKTOP = PRESETS_DEFAULT_DESKTOP;
	exports.PRESETS_DESKTOP = PRESETS_DESKTOP;
